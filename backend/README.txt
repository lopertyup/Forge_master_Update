...
────────────────────────────────────────────────────────────────────────────────
  ...
  Recalculer un opponent depuis capture     | pipeline.recompute_from_capture(img)
  Identifier les 8 pièces du joueur         | scanner.player_equipment.scan_player_equipment_image
  Scanner l'arme du joueur (zone dédiée)    | scanner.weapon.scan_player_weapon_image
