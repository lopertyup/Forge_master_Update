"""
============================================================
  FORGE MASTER -- Player equipment-panel offset table
  ...
  Two layouts:
    ...
    * data/player_equipment_offsets.json -- per-user overrides
      written by tools/calibrate_player_equipment.py
...
from .enemy_libraries import DATA_DIR
...
_OVERRIDES_PATH = DATA_DIR / "player_equipment_offsets.json"
