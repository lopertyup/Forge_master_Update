...
from ..calculator.item_keys import item_key as _item_key
from ..weapon.projectiles import RANGE_RANGED, get_travel_time
...
def scan_player_weapon_image(
    ...
    if is_ranged:
        ...
        from ..weapon.projectiles import get_projectile_speed, PVP_COMBAT_DISTANCE
