...
from .ocr_types import SLOT_TO_JSON_TYPE
from ..calculator.item_keys import item_key as _item_key, stat_type as _stat_type
from .panel import identify_equipment_panel
from ..persistence import empty_equipment, empty_equipment_slot
from .offsets import player as offsets_mod
